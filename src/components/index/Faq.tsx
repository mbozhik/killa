  ...
  return (
    <section id="faq" data-section="faq-main" className="grid w-screen mt-[20vh] mb-[25vh] h-auto place-items-center">
      <div className="flex flex-col justify-center gap-5">
        ...
        <div className="text-2xl font-medium text-center sm:text-left sm:text-lg sm:ml-5 xl:text-xl xl:tracking-normal" dangerouslySetInnerHTML={{__html: faqContent.text.description}}></div>
